    ...
    () async {
      ...
      try {
        ...
        try {
          ...
          debugPrint(
            'Could not load .env file, using default configuration: $e',
          );
        ...
        authProvider = AuthProvider(loading: true);
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider<AuthProvider, QuranProvider>(
          create: (_) => QuranProvider(),
          update: (_, auth, quran) {
            quran!.setUser(auth.userId);
            return quran;
          },
        ),
        ChangeNotifierProxyProvider<AuthProvider, MosqueProvider>(
          create: (_) => MosqueProvider(),
          update: (_, auth, mosque) {
            mosque!.setUser(auth.userId);
            return mosque;
          },
        ),
