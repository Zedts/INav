...
## Corpus Check
- 90 files · ~47,819 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1120 nodes · 1528 edges · 93 communities (61 shown, 32 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f127edc9`
...
Cohesion: 0.13
Nodes (14): IconData, _animation, build, color, _controller, createState, dispose, GlassPillBadge (+6 more)

### Community 16 - "State"
Cohesion: 0.14
Nodes (19): AnimationController, QiblaScreen, _QiblaScreenState, _PulsingDot, _PulsingDotState, _PulsingRing, _PulsingRingState, StreakCard (+11 more)
...
Cohesion: 0.15
Nodes (12): Color, build, color, icon, isActive, isDark, label, onTap (+4 more)

### Community 22 - "home_screen.dart"
Cohesion: 0.14
Nodes (21): ChangeNotifier, ../../core/providers/verse_provider.dart, PrayerProvider, StreakProvider, VerseProvider, build, createState, HomeScreen (+13 more)
...
Cohesion: 0.16
Nodes (14): ../../core/models/surah_model.dart, SurahModel, QuranProvider, build, build, _toggleAudio, _buildBottomActions, _toggleAudio (+6 more)
...
Cohesion: 0.17
Nodes (11): ../../core/theme/app_colors.dart, dart:ui, build, _buildEmptyState, _buildErrorState, _buildHeader, _buildLoadingState, _buildVerseContent (+3 more)
...
Cohesion: 0.17
Nodes (11): Animation, _buildPrayerStep, _calculateProgress, color, _controller, createState, dispose, _getCircleContent (+3 more)
...
### Community 85 - "nearest_mosque_banner.dart"
Cohesion: 0.17
...
### Community 89 - "bookmarks_sidebar.dart"
Cohesion: 0.25
...
Cohesion: 0.18
Nodes (10): MosqueModel, build, _buildIcon, _buildTrailing, isSelected, mosque, NearbyMosqueListTile, onNavigate (+2 more)

### Community 91 - "StatelessWidget"
Cohesion: 0.12
Nodes (18): SettingsScreen, ServicesToolsGrid, _FireButton, _MosquePinMarker, _UserLocationMarker, build, compact, isFavorite (+10 more)

### Community 93 - "app_header.dart"
Cohesion: 0.05
Nodes (49): ../../core/providers/qibla_provider.dart, ../../core/providers/streak_provider.dart, core/theme/app_theme.dart, ../../core/theme/theme_provider.dart, QiblaProvider, ThemeProvider, build, load (+41 more)
...
- **Why does `MosqueProvider` connect `MosqueProvider` to `mosque_provider.dart`, `main_screen.dart`, `nearest_mosque_banner.dart`, `home_screen.dart`, `favorites_sidebar.dart`, `QuranProvider`, `app_header.dart`, `mosque_detail_sheet.dart`?**
