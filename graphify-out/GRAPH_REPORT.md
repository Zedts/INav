...
## Corpus Check
- 84 files · ~42,763 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1013 nodes · 1351 edges · 94 communities (62 shown, 32 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb27d3ce`
...
Cohesion: 0.08
Nodes (23): Geocoding, checkPermission, city, country, countryCode, _formatAddress, formattedAddress, _geocoding (+15 more)
...
Cohesion: 0.12
Nodes (15): _animationController, build, createState, _currentProgress, didChangeDependencies, didUpdateWidget, dispose, initState (+7 more)
...
Cohesion: 0.05
Nodes (42): _cityName, clearSelection, closeSidebar, dispose, _errorMessage, _favoriteMosqueIds, _featuredMosqueId, initialize (+34 more)
...
Cohesion: 0.14
Nodes (13): Animation, _animation, build, color, _controller, createState, dispose, icon (+5 more)

### Community 16 - "State"
Cohesion: 0.33
Nodes (9): _PulsingDot, _PulsingDotState, _PulsingRing, _PulsingRingState, StreakCard, _StreakCardState, SingleTickerProviderStateMixin, State (+1 more)

### Community 17 - "mosque_service.dart"
Cohesion: 0.05
Nodes (40): @visibleForTesting, Client, dart:async, dart:convert, dart:io, Duration, Exception, int? (+32 more)
...
Cohesion: 0.14
Nodes (20): MosqueProvider, build, _buildContent, _buildErrorView, _buildLoadingView, createState, initState, MosqueScreen (+12 more)
...
Cohesion: 0.25
Nodes (14): ChangeNotifier, PrayerProvider, StreakProvider, VerseProvider, build, createState, HomeScreen, _HomeScreenState (+6 more)
...
Cohesion: 0.15
Nodes (13): ../common/glass_pill_badge.dart, build, _buildGlassCard, _buildPrayerSlide, _buildQuranSlide, createState, dispose, GlassBanner (+5 more)

### Community 27 - "QuranProvider"
Cohesion: 0.19
Nodes (12): ../core/providers/quran_provider.dart, QuranProvider, _exitActivePlayback, _toggleAudio, _buildBottomActions, _toggleAudio, build, _buildNumberBadge (+4 more)
...
Cohesion: 0.17
Nodes (11): ../../core/providers/prayer_provider.dart, core/providers/streak_provider.dart, core/providers/verse_provider.dart, core/theme/app_theme.dart, build, load, loadThemePreference, main (+3 more)
...
Cohesion: 0.25
Nodes (7): ../core/models/surah_model.dart, BookmarksSidebar, build, _buildBookmarksList, _buildEmptyState, _buildFooter, _buildHeader
...
Cohesion: 0.06
Nodes (36): CustomPainter, LatLng?, _DoughnutPainter, build, _buildAttributionBadge, _buildExpandedInfoCard, _buildMarkers, color (+28 more)

### Community 80 - "mosque_model.dart"
Cohesion: 0.09
Nodes (22): bool?, double?, LatLng? get, address, copyWith, distanceKm, fromJson, iconTag (+14 more)

### Community 81 - "horizontal_prayer_stepper.dart"
Cohesion: 0.14
Nodes (13): AnimationController, build, _buildPrayerStep, _calculateProgress, color, _controller, createState, dispose (+5 more)
...
Cohesion: 0.16
Nodes (15): AppHeader, build, _buildActions, _buildLeading, _buildLikeButton, _buildMosqueLeading, _buildNotificationButton, _buildQuranBookmarkButton (+7 more)
...
Cohesion: 0.18
Nodes (10): build, compact, isFavorite, MosqueFavoriteButton, MosqueNavigateButton, onInfo, onNavigate, onTap (+2 more)

### Community 92 - "StatelessWidget"
Cohesion: 0.22
Nodes (9): GlassPillBadge, _ServiceButton, ServicesToolsGrid, _FireButton, _MosquePinMarker, _UserLocationMarker, MosqueInfoButton, MosqueQuickActionsRow (+1 more)

### Community 93 - "package:flutter/material.dart"
Cohesion: 0.29
Nodes (5): build, QiblaScreen, build, SettingsScreen, package:flutter/material.dart

## Knowledge Gaps
- **559 isolated node(s):** `id`, `name`, `address`, `latitude`, `longitude` (+554 more)
...
- **Why does `MosqueProvider` connect `MosqueProvider` to `mosque_provider.dart`, `main_screen.dart`, `mosque_detail_sheet.dart`, `nearest_mosque_banner.dart`, `app_header.dart`, `favorites_sidebar.dart`, `home_screen.dart`?**
...
- **What connects `id`, `name`, `address` to the rest of the system?**
